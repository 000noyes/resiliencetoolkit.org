  ...
  <tr>
    ...
    <td data-label="Stuff">
      ...
      <div class="guide-table__checklist">
        ...
        <Todo id="ma-contact-info" moduleKey="mutual-aid" client:idle>
          Create a contact list of names, phone numbers, and addresses of households in your community (physical or social)
        </Todo>
        <Todo id="ma-identify-needs" moduleKey="mutual-aid" client:idle>
        ...
        <Todo id="ma-communication" moduleKey="mutual-aid" client:idle>
        ...
        <Todo id="ma-coordination" moduleKey="mutual-aid" client:idle>
        ...
        <Todo id="ma-resources" moduleKey="mutual-aid" client:idle>
          Check out <ExternalLink href="https://mutualaiddisasterrelief.org/collective-care/">Mutual Aid Disaster Relief's resources</ExternalLink> and the <ExternalLink href="https://docs.google.com/document/d/1dpMzMzsA83jbVEXS8m7QKOtK4nj6gIUk1U1t6P4wwiQ/edit">Big Door Brigade Mutual Aid Toolkit</ExternalLink>.
        </Todo>
      </div>
    </td>
  </tr>
