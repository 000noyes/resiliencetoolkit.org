...
const SECTION_PAGES = [
  ...
  { url: '/modules/emergency-preparedness/1-9', title: 'Community Emergency Response Plans', interactive: 'todo' },
  { url: '/modules/emergency-preparedness/1-10', title: 'Volunteer Management', interactive: 'todo' },
